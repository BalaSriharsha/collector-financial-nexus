      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm border border-collector-gold/20 p-8">
          ...
          <div className="space-y-6 text-gray-800">
            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">1. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">2. Description of Service</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">3. User Accounts</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">4. Subscription and Payment</h2>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">5. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">6. Data and Privacy</h2>
              <p>Your privacy is important to us. Please review our Privacy Policy, which also governs your use of the service, to understand our practices.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">7. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">8. Termination</h2>
              <p>We may terminate or suspend your account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold mb-3 text-collector-black">9. Contact Information</h2>
