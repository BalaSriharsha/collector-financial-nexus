    ...
    <div className="min-h-screen bg-gradient-to-br from-collector-white via-orange-50 to-amber-50">
      ...
      <header className="w-full py-6 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="text-sm text-collector-black/60 font-inter">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-6xl font-playfair font-bold text-collector-black mb-6">
            Master Your
            <span className="gradient-text block">Financial Empire</span>
          </h2>
          <p className="text-xl text-collector-black/70 max-w-2xl mx-auto font-inter leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto animate-fade-in">
            ...
            >
              <CardHeader className="text-center pb-8">
                <div className="w-20 h-20 bg-orange-gradient rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <User className="w-10 h-10 text-white" />
                </div>
                <CardTitle className="text-2xl font-playfair text-collector-black">
                  Individual
                </CardTitle>
                <CardDescription className="text-lg text-collector-black/70">
                  Personal financial mastery
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3 text-collector-black/80">
                  <TrendingUp className="w-5 h-5 text-collector-orange" />
                  <span>Income & Expenditure Tracking</span>
                </div>
                <div className="flex items-center space-x-3 text-collector-black/80">
                  <PieChart className="w-5 h-5 text-collector-gold" />
                  <span>Budget Planning & Savings</span>
                </div>
                <div className="flex items-center space-x-3 text-collector-black/80">
            ...
            >
              <CardHeader className="text-center pb-8">
                <div className="w-20 h-20 bg-gold-gradient rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3 text-collector-black/80">
                  <TrendingUp className="w-5 h-5 text-collector-orange" />
                  <span>Revenue & Expense Management</span>
                </div>
                <div className="flex items-center space-x-3 text-collector-black/80">
                  <PieChart className="w-5 h-5 text-collector-gold" />
                ...
                <div className="flex items-center space-x-3 text-collector-black/80">
                  <FileText className="w-5 h-5 text-collector-orange" />
        ...
        {userType && !showDashboard && (
          <div className="text-center mt-12 animate-fade-in">
            <Button 
              ...
              className="bg-blue-gradient hover:bg-blue-600 text-white px-12 py-4 text-lg font-playfair rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
      ...
      {/* Features Preview */}
      <section className="max-w-7xl mx-auto px-4 py-16 border-t border-collector-gold/20">
        <div className="text-center mb-12">
          <h3 className="text-4xl font-playfair font-bold text-collector-black mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center animate-fade-in">
            <div className="w-16 h-16 bg-orange-gradient rounded-full flex items-center justify-center mx-auto mb-4 animate-float">
              <FileText className="w-8 h-8 text-white" />
            </div>
            <h4 className="text-xl font-playfair font-semibold text-collector-black mb-2">
              Document Sanctum
            </h4>
          ...
          <div className="text-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="w-16 h-16 bg-gold-gradient rounded-full flex items-center justify-center mx-auto mb-4 animate-float" style={{ animationDelay: '1s' }}>
          ...
          <div className="text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <div className="w-16 h-16 bg-blue-gradient rounded-full flex items-center justify-center mx-auto mb-4 animate-float" style={{ animationDelay: '2s' }}>
